...
// Fetch NECO resources with volunteer info (only approved resources)
$query = "
    ...
    WHERE resources.category = 'NECO' AND resources.is_approved = 1
...
<title>NECO Resources - EduConnect NG</title>
...
<nav class="bg-green-600 p-4 shadow-md">
    <div class="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <span class="text-white font-semibold">NECO Resources</span>
    </div>
</nav>

<div class="max-w-6xl mx-auto mt-10 px-4">

    <h2 class="text-2xl font-bold text-gray-800 mb-6">NECO Study Materials</h2>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-xl shadow hover:shadow-lg transition">
                    ...
                    <?php if (!empty($row['file_path'])): ?>
                        <a 
                            ...
                            class="block mt-4 text-center bg-green-600 text-white p-2 rounded hover:bg-green-700"
                            target="_blank"
                        >
                            View / Download
                        </a>
        ...
        <?php else: ?>
            <div class="col-span-3 bg-white p-8 rounded-lg shadow text-center">
                <p class="text-gray-600">No NECO resources have been uploaded yet.</p>
            </div>
        <?php endif; ?>
